...
class SportstensorBaseModel(SportPredictionModel):
    ...
    def intelligent_fallback_prediction(self, reason: str = "API failed"):
        ...
        try:
            ...
            bt.logging.info(
                f"🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯🎯\n"
                f"   FALLBACK PREDICTION: {self.prediction.homeTeamName} vs {self.prediction.awayTeamName}\n"
                f"   Winner: {self.prediction.probabilityChoice}\n"
                f"   Probability: {self.prediction.probability:.3f} ({self.prediction.probability*100:.1f}%)\n"
                f"   Home Strength: {home_strength:.2f}, Away Strength: {away_strength:.2f}\n"
